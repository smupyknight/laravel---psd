		...
		<nav class="navbar-default navbar-static-side" role="navigation">
			<div class="sidebar-collapse">
				<ul class="nav metismenu" id="side-menu">
					<li class="nav-header">
						<div class="dropdown profile-element">
							...
							<li{!! Request::is('admin/services*') ? ' class="active"' : '' !!}><a href="/admin/services"><i class="fa fa-dashboard"></i> <span class="nav-label">Services</span></a></li>
						</ul>
					</div>
				</nav>
				<div id="page-wrapper" class="gray-bg">
					...
					<div class="footer">
						<div>
							<strong>Copyright</strong> PSD &copy; {{ date('Y') }}
						</div>
					</div>
				</div>
